...
export function PositionsErrorFallback({
  error,
  onRetry,
}: {
  error?: Error;
  ...
  const errorConfig = {
    network: {
      ...
      description:
        "Không thể tải danh sách chức vụ. Vui lòng kiểm tra kết nối internet của bạn.",
      color: "blue",
    },
    notFound: {
      icon: "👨‍⚕️",
      title: "Không tìm thấy chức vụ",
      description: "Hiện tại chưa có chức vụ nào trong hệ thống.",
      color: "gray",
    },
    general: {
      icon: "⚠️",
      title: "Đã xảy ra lỗi",
      description: "Không thể tải danh sách chức vụ. Vui lòng thử lại sau.",
      color: "red",
    },
  };
